function [Kg]=WELCHComputeKgIS(n1,n2,h1,h2,tol,method)
%Compute Kg for the Welch test, independent samples
%(c) Dmitrii Zholud 2011
%
%Example: 
%>> WELCHComputeKgIS(3,2,@(x) mvnpdf(x,[0 0 0],diag([2 2 2])),@(x) mvnpdf(x,[0 0],diag([1 1])),1e-6,@ quadl)
%ans = 7^(3/2)/18
%    = 1.0289
