function [PValuesRaw, PValuesCorrected]=FSimulatePValues(dist,n1,n2,r,Kg)
...
while (k*buf<N)
    ...
    PValuesCorrected_tmp=Kg*(1-fcdf(F,n1-1,n2-1));
    ...
    PValuesRaw_tmp=1-fcdf(F,n1-1,n2-1);
...
SavePValues('F',dist,0,n1,n2,r,res,Kg,PValuesRaw,PValuesCorrected);