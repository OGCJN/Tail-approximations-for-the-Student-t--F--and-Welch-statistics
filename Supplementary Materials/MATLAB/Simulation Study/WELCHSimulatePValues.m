function [PValuesRaw,PValuesCorrected]=WELCHSimulatePValues(dist,n1,n2,r,Kg)
% dist    - population distribution: 'Exponential', 'Standard normal' 
%           and t-densities 't2', 't3', 't4', e.t.c.    
...
while (k*buf<N)
    ...
    df_Welch=...
    (alpha*S1.^2+beta*S2.^2).^2./...
    ((alpha^2*S1.^4)/(n1-1)+(beta^2*S2.^4)/(n2-1));
    ...
    PValuesRaw_tmp=1-tcdf(T,df_Welch);
...
SavePValues('WELCH',dist,0,n1,n2,r,res,Kg,PValuesRaw,PValuesCorrected);