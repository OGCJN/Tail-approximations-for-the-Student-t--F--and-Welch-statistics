function [Kg]=WELCHComputeKg(n1,n2,g,tol,method)
%Compute Kg for the Welch test,
%(c) Dmitrii Zholud 2011
%
%Example: 
%>> WELCHComputeKg(3,2,@(x) mvnpdf(x,[0 0 0 0 0],[1 1/2 -1/3 0 1/3; 1/2 2 1/6 0 0; -1/3 1/6 3 0 1/5; 0 0 0 4 1/2; 1/3 0 1/5 1/2 5;]),1e-6,@ quadl)
%ans = 7547405*sqrt(1509481)/3993677192
%    = 2.3219
