function [Kg]=TSTComputeKgIID(n1,n2,h,tol,method)
%Compute Kg for the Student two-sample t-test, i.i.d. case
%(c) Dmitrii Zholud 2011
%
%Example: 
%>> TSTComputeKgIID(2,3,@(x) pdf('Normal',x,0,1),1e-6,@ quadl)
%ans =
%    1.0000
